...
module.exports = async (basicIO) => {
	...
	*/
	...
	let query = "select Module, LearningObjective, ROWID, Name, Content, IsActive, SupportingText, SupportingAVURL, SupportingImageURL, Sequence, Persona, ObjectiveMessage, Type, ShowLearningContent, IsPaid from SystemPrompts"
	var conditions = []
